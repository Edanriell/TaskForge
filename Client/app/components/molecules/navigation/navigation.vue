...
<template>
	<ul class="menu">
		<li class="mb-2">
			<NuxtLink class="font-semibold text-base hover:bg-base-300 rounded-lg px-3 py-2" to="/">
				Overview
			</NuxtLink>
		</li>
		<li class="menu-title mt-6 text-gray-500 uppercase text-xs tracking-wider">Projects</li>
		<li
		...
		>
			<details class="group" open>
				...
				>
					<li v-for="(task, index) in project.tasks" :key="index" class="text-sm">
